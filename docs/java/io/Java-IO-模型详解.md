...
像我们平常运行的应用程序都是运行在用户空间，只有内核空间才能进行系统态级别的资源有关的操作，比如文件管理、进程通信、内存管理等。也就是说，我们想要进行 IO 操作，一定是要依赖内核空间的能力
...
![Buffer、Channel和Selector三者之间的关系](assets/channel-buffer-selector.png)
...
![](assets/3077e72a1af049559e81d18205b56fd7tplv-k3u1fbpfcp-watermark.png)
