...
> 乐观锁：CAS 实现
>
> 悲观锁：每次获取资源都上锁，实现有 `synchronized` 和 `ReentrantLock`
...
![JUC原子类概览](assets/JUC原子类概览-20230814005415437.png)
...
1. i 与 1 比较，如果相等， 则说明没被其他线程修改，可以被设置为 6
2. i 与 1 比较，如果不相等，则说明被其他线程修改，当前线程放弃更新，CAS 操作失败
